...
<?php include 'header.php';?>
        ...
        <section id="slug">
            <div class="container">
                <div class="slug-link">
                    <a href="index.php" class="slug-lv1">Trang chủ </a><i class="fas fa-caret-right"></i><a
                        class="slug-lv2" href="#"> Liên hệ</a></i>
                </div>
            </div>
        </section>
        ...
        <section class="contact-wrapper">
            <div class="container">
                <div class="contact-left">
                        ...
                        <div class="contact-address__name">
                            
                            Hồ chí minh
                        </div>
                        <div class="contact-address__detail">
                           <span> <i class="fas fa-street-view"></i><p> A75/6C/7 Bạch Đằng, phường 2, quận Tân Bình, TP.HCM</p></span> 
                           <span> <i class="fas fa-phone-alt"></i><p>0972827996</p></span>
                        </div>
                        <div class="contact-address__name">
